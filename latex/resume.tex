...
\cvlistitem{ Image/video processing}
\cvlistitem{ Computer vision}
\cvlistitem{ Machine learning}
\cvlistitem{ Deep learning}
\cvlistitem{ Android sdk/ndk}
\cvlistitem{ Raspberry Pi}
...
\cvlistitem{ Algorithm Design (18.25)}
\cvlistitem{ Computer vision (17.75)}
...
\cvitem{Tools and Technologies}{OpenCV, Tensorflow, Keras, Matlab, Android SDK/NDK}
\cvitem{Operating Systems}{GNU/Linux, Android}
